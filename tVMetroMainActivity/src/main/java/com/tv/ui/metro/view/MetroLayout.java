		...
		switch (celltype) {
			case Vertical:
				flp = new LayoutParams(
						...
						(int) (ITEM_V_HEIGHT * mDensityScale+padding));
				if (rowOffset[0] == rowOffset[1]) {
					...
					if (rowOffset[0] - rowOffset[1] > 300) {
						if (mMirror) {
							MirrorItemView mirror = new MirrorItemView(mContext);
							mirror.setContentView(child, flp);
							flp.bottomMargin = mirror_ref_height;
					...
					if (rowOffset[0] - rowOffset[1] < 300&&rowOffset[0] - rowOffset[1]>50) {
						if (mMirror) {
							MirrorItemView mirror = new MirrorItemView(mContext);
							mirror.setContentView(child, flp);
							flp.bottomMargin = mirror_ref_height;
					...
					if (rowOffset[1] - rowOffset[0] > 300) {
						if (mMirror) {
							MirrorItemView mirror = new MirrorItemView(mContext);
							mirror.setContentView(child, flp);
							flp.bottomMargin = mirror_ref_height;
					...
					if (rowOffset[1] - rowOffset[0] < 300&&rowOffset[0] - rowOffset[1]>50) {
						if (mMirror) {
							MirrorItemView mirror = new MirrorItemView(mContext);
							mirror.setContentView(child, flp);
							flp.bottomMargin = mirror_ref_height;
			...
			case Horizontal:
				flp = new LayoutParams((int) (ITEM_H_WIDTH * mDensityScale+padding), (int) (ITEM_H_HEIGHT * mDensityScale));
				if(a==1){
					rowOffset[1] -= (ITEM_H_WIDTH + ITEM_V_WIDTH + padding+padding+padding);
					if (mMirror) {
						MirrorItemView mirror = new MirrorItemView(mContext);
						mirror.setContentView(child, flp);
						flp.bottomMargin = mirror_ref_height;
					...
					rowOffset[1] += (ITEM_H_WIDTH * mDensityScale + padding+padding+padding + ITEM_V_WIDTH);
					a -= 1;
					break;}
				else if(c==1){
					rowOffset[0] -= (ITEM_H_WIDTH + ITEM_V_WIDTH + padding+padding+padding);
					flp.leftMargin = rowOffset[0];
					flp.topMargin = getPaddingTop();
					flp.rightMargin = getPaddingRight();
					child.setFocusable(true);
					...
					child.setTag(R.integer.tag_view_postion, 0);
					addView(child, flp);
					rowOffset[0] += (ITEM_H_WIDTH * mDensityScale + padding+padding+padding + ITEM_V_WIDTH);
					c -= 1;
					break;
				}else {
					if (rowOffset[0] <= rowOffset[1]){
					...
					child.setTag(R.integer.tag_view_postion, 0);
					addView(child, flp);
					rowOffset[0] += (ITEM_H_WIDTH * mDensityScale + padding+padding);
					break;
				}else{
					if (mMirror) {
						MirrorItemView mirror = new MirrorItemView(mContext);
					...
					rowOffset[1]+=(ITEM_H_WIDTH*mDensityScale+padding+padding);
					break;
				}
				}
...
//			break;
			case Normal:
				...
				if (a==1){
					if (mMirror) {
					rowOffset[1] -= (ITEM_H_WIDTH + ITEM_V_WIDTH + padding);
					MirrorItemView mirror = new MirrorItemView(mContext);
					mirror.setContentView(child, flp);
					flp.bottomMargin = mirror_ref_height;
					flp = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
					...
					rowOffset[0] -= (ITEM_H_WIDTH + ITEM_V_WIDTH + padding);
					flp.leftMargin = rowOffset[0];
					flp.topMargin = getPaddingTop();
					flp.rightMargin = getPaddingRight();
					child.setFocusable(true);
					...
					child.setTag(R.integer.tag_view_postion, 0);
					addView(child, flp);
					rowOffset[0] += (ITEM_H_WIDTH * mDensityScale + padding + ITEM_V_WIDTH);
					c -= 1;
					d = 1;
					break;
				}else if(d==1){
					rowOffset[0] -= (ITEM_NORMAL_SIZE * mDensityScale + padding + ITEM_V_WIDTH);
					flp.leftMargin = rowOffset[0];
					flp.topMargin = getPaddingTop();
					flp.rightMargin = getPaddingRight();
					child.setFocusable(true);
