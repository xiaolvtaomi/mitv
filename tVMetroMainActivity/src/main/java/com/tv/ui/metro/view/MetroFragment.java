...
public class MetroFragment extends Fragment implements BaseScrollLisener{
    ...
    public void initViews(){
        ...
        if(isUserTab == true){
            ...
            for(DisplayItem item:tab.items){
                ...
                addView(new RecommendCardView(getActivity(), type).bindData(item),  type,  item._ui.layout.h-1);
            }
        }
    }
